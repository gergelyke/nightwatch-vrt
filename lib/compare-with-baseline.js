...
const buildkiteInlineImage = require('@nib/buildkite-inline-image');
            ...
            if (!identical && prompt === true) {
                saveScreenshot(
                    ...
                    then(() => {
                        ...
                        console.log('Baseline image:')
                        buildkiteInlineImage.inlineArtifactImage(completeBaselinePath)
                        console.log('Latest image:')
                        buildkiteInlineImage.inlineArtifactImage(completeLatestPath)
                        console.log('Diff image:')
                        buildkiteInlineImage.inlineArtifactImage(completeDiffPath)
                    })
                    .then(
                        resolve
                    )
